...
parser.add_argument('--sig-T', type=float, default=8)
...
parser.add_argument('--k_easy',type=int,default=5)
parser.add_argument('--k_hard',type=int,default=20)
...
parser.add_argument('--metric',type=str, default='Mahala', choices=['KL_div','Bhatta','Mahala'])
...
parser.add_argument('--alpha6',type=float,default=0.1)
parser.add_argument('--alpha7',type=float,default=0.5)

# test
parser.add_argument('--test_topk',type=int,default=15)
