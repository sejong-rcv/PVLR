...
parser.add_argument('--path-clip-dataset', type=str, default='features/Thumos14_CLIP', help='the path of data feature')
parser.add_argument('--model-name', default='PVLR', help='name to save model')
parser.add_argument('--pretrained-ckpt', default='./model/PVLR_init.pth', help='ckpt for pretrained model')
...
parser.add_argument('--proposal-method',type=str,default='multiple_threshold_hamnet')
...
parser.add_argument('--max-iter', type=int, default=7001, help='maximum iteration to train (default: 50000)')
...
parser.add_argument('--warmup-iter', type=int, default=3500, help='time interval of performing the test')
...
parser.add_argument('--vid-thresh',type=float,default=0.2)
parser.add_argument('--soft-nms-thresh',type=float,default=0.7)
parser.add_argument('--gamma-oic', type=float, default=0.1)
parser.add_argument('--sigma',type=float,default=0.2)
parser.add_argument('--cas_scale',type=float,default=1)
parser.add_argument('--cas_gamma-oic', type=float, default=0.5)
parser.add_argument('--cas_lambda_',type=float,default=0.1)
parser.add_argument('--act_scale',type=float,default=1)
parser.add_argument('--act_gamma-oic', type=float, default=0.05)
parser.add_argument('--act_lambda_',type=float,default=0.1)
